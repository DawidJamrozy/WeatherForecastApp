...
import com.dawidj.weatherforecastapp.view.adapters.CitiesRecycerViewAdapter;
...
public class MyCitiesActivity extends AppCompatActivity {
    ...
    private CitiesRecycerViewAdapter citiesRecycerViewAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.setMyCitiesViewModel(myCitiesViewModel);
    ...
    public void setRecycler() {
        ...
        citiesRecycerViewAdapter = new CitiesRecycerViewAdapter(this, myCitiesViewModel.getCityList());
        recyclerView.setAdapter(citiesRecycerViewAdapter);
    }
